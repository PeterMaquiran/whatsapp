...
| [14 Decisions](./14-decisions.md) | ADRs: Socket.IO first, NestJS gateway host, Postgres first, credential multi-device, IdP (Google / later Keycloak) not session, no E2E in v1, TUS media, OTel Collector + Tempo/Loki/Prometheus |
